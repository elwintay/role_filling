#! /bin/bash
gpu=1
train_path=../gtt_data/train.json
dev_path=../gtt_data/dev.json
test_path=../gtt_data/test.json
epochs=1
batch_size=1
max_token_len=2000
workers=12
...
--workers ${workers} --model_path ${model_path} --warmup_steps ${warmup_steps} --do_train